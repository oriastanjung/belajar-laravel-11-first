<x-layout-admin>
    ...
    <section class="mt-20 px-10">
        ...
        <table class="min-w-full bg-white rounded-lg shadow-md overflow-x-auto">
            ...
            <tbody class="text-gray-700">
                ...
                <tr class="border-b">
                    ...
                    <td class="py-3 px-4">
                        <img src="{{ asset('storage/' . $place->thumbnail) }}" alt="{{ $place->name }}" class="w-16 h-16 object-cover rounded-lg">
                    </td>
